...
2021-04-22
:jbake-type: post
:jbake-tags: java, jakarta-ee, mvc, freemarker
:jbake-status: published
:jbake-summary: Jakarta MVC is the coming web UI framework under the hood of Jakarta EE. One exceptional feature of Jakarta MVC is the pluggable view engine architecture, which allows to integrate different template engines. This Blog post is about the integration of FreeMarker Template Engine with Jakarta MVC.
...
image::JakartaMvcApp_Hello.png[Jakarta MVC sample application]
